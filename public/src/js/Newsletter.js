...
var Newsletter = React.createClass({displayName: "Newsletter",
  ...
  render: function(){
    ...
    return (
      React.createElement("div", {className: "email-wrapper"}, 
        React.createElement("div", {id: "content", className: "email-content", style: {width: this.state.windowWidth - this.builderWidth, textAlign: 'center', background: 'url(http://i.imgur.com/crA7q0C.jpg) top left repeat-x #E2E2E2'}}, 
          React.createElement("table", {cellPadding: 0, cellSpacing: 0, width: "100%", background: "http://i.imgur.com/crA7q0C.jpg", style: {backgroundRepeat: 'repeat-x'}}, 
            React.createElement("tbody", null, 
              React.createElement("tr", null, 
                React.createElement("td", null, 
                  React.createElement("center", null, 
                    React.createElement("div", {style: {maxWidth: 665, margin: '0 auto'}}, 
                    	React.createElement("table", {cellPadding: 0, cellSpacing: 0, style: {minWidth: 320, width: '100%'}, align: "center"}, 
                	    	React.createElement("tbody", null, 
                            React.createElement(Header, {hotlineNumber: this.state.common.hotlineNumber}), 
                            this.state.elements[this.state.lang].map(function(tag, i){
                                var tagKind = tag.tag;
                                switch(tagKind) {
                                    case TAGS.CATEGORIES: return React.createElement(CATEGORIES, React.__spread({posx: i},  elementProps, {content: self.state.content}));
                                        break;
                                    case TAGS.PLAINTEXT: return React.createElement(PLAINTEXT, React.__spread({posx: i},  elementProps, {data: tag.data}));
                                        break;
                                    case TAGS.HTMLCODE: return React.createElement(HTMLCODE, React.__spread({posx: i},  elementProps, {data: tag.data}));
                                        break;
                                    case TAGS.COUPLE: return React.createElement(COUPLE, React.__spread({posx: i},  elementProps, {data: tag.data, common: self.state.common, tracking: tracking}));
                                        break;
                                    case TAGS.SINGLE: return React.createElement(SINGLE, React.__spread({posx: i},  elementProps, {data: tag.data, common: self.state.common, tracking: tracking}));
                                        break;
                                    case TAGS.TITLE: return React.createElement(TITLE, React.__spread({posx: i},  elementProps, {img: self.state.content[tag.data.kind]}));
                                        break;
                                    case TAGS.FOOTER: return React.createElement(BodyFooter, React.__spread({posx: i},  elementProps, {content: self.state.content}));
                                        break;
                                    default: return '';
                                }
                            })
                  ...
                  React.createElement(Footer, {content: this.state.content})
                )
              )
            )
          )
        ), 
        React.createElement(ContextMenu, React.__spread({},  contextMenuProps)), 
        React.createElement(Builder, React.__spread({},  builderProps, {className: "email-builder", style: {width: this.builderWidth}}))
      )
    )
  }
});